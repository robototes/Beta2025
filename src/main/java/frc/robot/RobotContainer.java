...
public class RobotContainer {
  ...
  private void configureBindings() {
                ...
                drive
                    ...
                    .withRotationalRate(
                        -driveController.getRightX()
                            * MaxAngularRate
                            * (slowMode ? 0.5 : 1)) // Drive counterclockwise with negative X (left)
            ));
    ...
    codriveController
        .leftBumper()
        .whileTrue(algaeGroundIntake.runAtSpeed(() -> codriveController.getLeftY()));
    codriveController
        .rightBumper()
        .whileTrue(coralGroundIntake.SpinSpeed(() -> -codriveController.getRightY()));
